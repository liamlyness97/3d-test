...
>
	...
	<button
		...
		aria-label="Wheel"
	>
		<img class="h-4 w-4" src="/icons/wheel.svg" alt="Wheel Icon" />
	</button>
	<button
		onclick={() => {
			partColours.frontRim = '#025c8d';
			controls?.setPosition(1.8, 0.5, 0, true);
			controls?.setTarget(0, 0.5, 0, true);
			tab = 'config';
		}}
