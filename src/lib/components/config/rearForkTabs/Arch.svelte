	...
	>
		...
		<div class="grid grid-cols-10 justify-center gap-4">
			{#each materials.enamel.colours as colour}
				<button
					onclick={() => {
						partsConfig.rearForksArch.colour = colour.colour;
						partsConfig.rearForksArch.colourName = colour.name;
						partsConfig.rearForksArch.colourNumber = colour.number;
						partsConfig.rearForksArch.roughness = materials.enamel.roughness;
						partsConfig.rearForksArch.metalness = materials.enamel.metalness;
						partsConfig.rearForksArch.transmission = materials.enamel.transmission;
						partsConfig.rearForksArch.transparent = materials.enamel.transparent;
						partsConfig.rearForksArch.clearcoat = materials.enamel.clearcoat;
						partsConfig.rearForksArch.normalMap = false;
						partsConfig.rearForksArch.normalScale = [0, 0];
						partsConfig.rearForksArch.clearcoatRougness = materials.enamel.clearcoatRougness;
						partsConfig.rearForksArch.materialType = 'enamel';
						controls?.setPosition(0.8, 0.7, 0.8, true);
						controls?.setTarget(0.2, 0.2, -0.2, true);
					}}
			...
			{#each materials.pearl.colours as colour}
				<button
					onclick={() => {
						...
						partsConfig.rearForksArch.colourName = colour.name;
						partsConfig.rearForksArch.colourNumber = colour.number;
						partsConfig.rearForksArch.roughness = materials.pearl.roughness;
						partsConfig.rearForksArch.metalness = materials.pearl.metalness;
						partsConfig.rearForksArch.transmission = materials.pearl.transmission;
						partsConfig.rearForksArch.transparent = materials.pearl.transparent;
						partsConfig.rearForksArch.clearcoat = materials.pearl.clearcoat;
						partsConfig.rearForksArch.normalMap = materials.pearl.normalMap;
						partsConfig.rearForksArch.normalScale = [
							materials.pearl.normalScale[0],
							materials.pearl.normalScale[1]
						];
						partsConfig.rearForksArch.clearcoatRougness = materials.pearl.clearcoatRougness;
						partsConfig.rearForksArch.materialType = 'pearl';
						controls?.setPosition(0.8, 0.7, 0.8, true);
						controls?.setTarget(0.2, 0.2, -0.2, true);
					}}
					class="flex h-10 w-10 -translate-y-0 items-center justify-center rounded-full border border-brandBlue bg-white text-[1rem] font-medium duration-300 ease-out hover:-translate-y-1"
