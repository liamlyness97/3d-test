...
Command: npx @threlte/gltf@3.0.1 ./static/mercian-models/lugged-logo-2.glb --draco
-->
...
<script>
	...
	const gltf = useGltf('/mercian-models/lugged-logo-4.glb', { dracoLoader: dracoLoader });
</script>
...
<T.Group bind:ref dispose={false} {...props} position={[0.0, 0.1, 0.1]}>
	...
	{:then gltf}
		...
		<T.Mesh geometry={gltf.nodes.seat_tube.geometry} material={gltf.nodes.seat_tube.material}>
			<T.MeshStandardMaterial color={partColours.frame} roughness={0.036491} metalness={0.346457} />
		</T.Mesh>
