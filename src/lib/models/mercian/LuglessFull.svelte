...
<T.Group bind:ref dispose={false} {...props}>
	...
	{:then gltf}
		<!-- Solid Poll w/Cuts -->
		<T.Mesh
			geometry={gltf.nodes.Pole__Full.geometry}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole__Cut_Top_Keyline.geometry}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole__Cut_Full_Bottom_Keyline.geometry}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole__Cut_Top_Section.geometry}
			material={gltf.materials['Material.011']}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole__Cut_Top_Gap.geometry}
			material={gltf.nodes.Pole__Cut_Top_Gap.material}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole__Cut_Bottom_Section.geometry}
			material={gltf.materials['Material.011']}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole__Cut_Bottom_Gap.geometry}
			material={gltf.nodes.Pole__Cut_Bottom_Gap.material}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole__Cut_Top_Gap_Keyline.geometry}
			material={gltf.materials.Material}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole__Cut_Centre_Top_Keyline.geometry}
			material={gltf.materials.Material}
			visible={polePattern.poleTopGapTopKeyline}
		>
			<T.MeshPhysicalMaterial
		...
		<T.Mesh
			geometry={gltf.nodes.Pole__Cut_Bottom_Gap_Keyline.geometry}
			material={gltf.materials['Material.012']}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole__Cut_Centre_Bottom_Keyline.geometry}
			material={gltf.materials['Material.012']}
