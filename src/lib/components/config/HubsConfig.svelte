...
>
	...
	<button
		onclick={() => {
			partColours.backHub = '#025c8d';
			partColours.frontHub = '#025c8d';
			controls?.setPosition(1.8, 0.5, 0, true);
			controls?.setTarget(0, 0.5, 0, true);
			tab = 'config';
		}}
	...
	<button
		onclick={() => {
			partColours.backHub = '#560606';
			partColours.frontHub = '#560606';
			controls?.setPosition(1.8, 0.5, 0, true);
			controls?.setTarget(0, 0.5, 0, true);
			tab = 'config';
		}}
	...
	<button
		onclick={() => {
			partColours.backHub = '#033a1d';
			partColours.frontHub = '#033a1d';
			controls?.setPosition(1.8, 0.5, 0, true);
			controls?.setTarget(0, 0.5, 0, true);
			tab = 'config';
		}}
	...
	<button
		onclick={() => {
			partColours.backHub = '#b2391b';
			partColours.frontHub = '#b2391b';
			controls?.setPosition(1.8, 0.5, 0, true);
			controls?.setTarget(0, 0.5, 0, true);
			tab = 'config';
		}}
	...
	<button
		onclick={() => {
			partColours.backHub = '#d56c7a';
			partColours.frontHub = '#d56c7a';
			controls?.setPosition(1.8, 0.5, 0, true);
			controls?.setTarget(0, 0.5, 0, true);
			tab = 'config';
		}}
	...
	<button
		onclick={() => {
			partColours.backHub = '#151619';
			partColours.frontHub = '#151619';
			controls?.setPosition(1.8, 0.5, 0, true);
			controls?.setTarget(0, 0.5, 0, true);
			tab = 'config';
		}}
