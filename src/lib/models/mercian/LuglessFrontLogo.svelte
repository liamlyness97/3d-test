...
Command: npx @threlte/gltf@3.0.1 ./static/mercian-models/lugless-logo-keyline-2.glb --draco
-->
...
<script>
	...
	const gltf = useGltf('/mercian-models/lugless-logo-front-logo.glb', {
...
<T.Group bind:ref dispose={false} {...props}>
	...
	{:then gltf}
		<T.Mesh
			geometry={gltf.nodes.Mercian_Logo.geometry}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole_Keyline_1.geometry}
		...
		<T.Mesh
			geometry={gltf.nodes.Pole_Keyline_2.geometry}
